        ...
        <div class="row middle-header">
            ...
            <div class="col-md-5 col-xs-12 tab-con">
                <div class="row search-box">
                    <form action="/search">
                        ...
                        <input type="text" name="q" class="col-md-11 provider-json" placeholder="Rechercher..."/>
            ...
            <div class="col-md-4 col-xs-12 text-center tab-con">
                <div class="row">
                            ...
                            <div class="animated user-overlap sbox3">
                                <div class="overlap-profile-viewer">
                                    ...
                                    <?php if(isset($user) && isset($user['vendor']) && $user['vendor'] == 1): ?>
                                        <div class="overlap-profile-viewer-info">
                                            ...
                                            <a href="/user/dashboard" class="btn btn-danger"><?php echo e(__('admin.admin_panel')); ?></a>
                                        </div>
                                    <?php else: ?>
                                        <div class="overlap-profile-viewer-info">
                                ...
                                <ul>
                                    <li><a href="/profile/<?php echo e($user['id']); ?>"><span class="headericon mdi mdi-account"></span>
                                            <p><?php echo e(trans('main.profil')); ?></p></a></li>
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(url($locale.'/login')); ?>" class="header-login-button"><span class="headericon mdi mdi-account"></span><?php echo e(trans('main.login_signup')); ?></a>
                        <!--<a href="<?php echo e(url($locale.'/category')); ?>" class="main-header">-->                                                                                                                                                           
                        <?php endif; ?>
                </div>
            </div>
        </div>
