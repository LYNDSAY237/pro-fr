        ...
        <div class="row middle-header">
            ...
            <div class="col-md-4 col-xs-12 text-center tab-con">
                <div class="row">
                    ...
                    @else
                        <a href="{{url($locale.'/login')}}" class="header-login-button"><span class="headericon mdi mdi-account"></span>{{ trans('main.login_signup') }}</a>
                        <!--<a href="{{url($locale.'/category')}}" class="main-header">-->                                                                                                                                                           
                        @endif
                </div>
            </div>
        </div>
